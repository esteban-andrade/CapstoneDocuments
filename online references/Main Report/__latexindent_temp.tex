...
In complex calculations, it is possible to perform a \textit{least-squares fit} to minimize the difference between the gradient of $f$ and $V$\Citet*{Poisson}.
...
\begin{figure}[H]
  \centering
  \subfloat[RIG From View]{{\includegraphics[width=0.5\textwidth]{IMG_5883.JPG} }}
  \qquad
  \subfloat[RIG lateral View]{{\includegraphics[width=0.5\textwidth]{IMG_5884.JPG} }}
