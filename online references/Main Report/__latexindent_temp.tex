...
\begin{table}[H]
  \centering
  \makebox[\textwidth]
  {\includegraphics[width=1\linewidth]{camerainit_table.png}    
  }
  \caption{Meshroom CameraInit Node }
  \label{tab:CameraInit}
  \end{table}
...
\newpage
  ...
  \begin{table}[H]
    \centering
    \makebox[\textwidth]
    {\includegraphics[width=1\linewidth]{featureExtractionTable.png}    
    }
    \caption{Meshroom FeatureExtraction Node Settings}
    \label{tab:FeatureExtraction}
    \end{table}
    ...
    \begin{table}[H]
      \centering
      \makebox[\textwidth]
      {\includegraphics[width=1\linewidth]{ImageMatchingTable.png}    
      }
      \caption{Meshroom FeatureExtraction Node Settings}
      \label{tab:ImageMatching}
      \end{table}
      ...
      \begin{table}[H]
        \centering
        \makebox[\textwidth]
        {\includegraphics[width=1\linewidth]{featurematchingtable.png}    
        }
        \caption{Meshroom Feature Matching Node}
        \label{tab:FeatureMatching}
        \end{table}
...
\begin{table}[H]
  \centering
  \makebox[\textwidth]
  {\includegraphics[width=1\linewidth]{SFM_table.png}    
  }
  \caption{Meshroom StructureFromMotion Node}
  \label{tab:StructureFromMotion}
  \end{table}
...
\begin{table}[H]
  \centering
  \makebox[\textwidth]
  {\includegraphics[width=1\linewidth]{PrepareDenseSceneTable.png}    
  }
  \caption{Meshroom Prepare Dense Scene Node}
  \label{tab:PrepareDenseScene}
  \end{table}
  ...
  \begin{table}[H]
    \centering
    \makebox[\textwidth]
    {\includegraphics[width=1\linewidth]{DepthMapTable.png}    
    }
    \caption{Meshroom Depth MapNode}
    \label{tab:DepthMap}
    \end{table}  
...
%   \end{table}
  ...
  \begin{table}[H]
    \centering
    \makebox[\textwidth]
    {\includegraphics[width=1\linewidth]{DepthMapFilterTable.png}    
    }
    \caption{Meshroom Depth Map Filter Node}
    \label{tab:DepthMapFilter}
    \end{table}  
  ...
  %   \end{table}
    ...
    \begin{table}[H]
      \centering
      \makebox[\textwidth]
      {\includegraphics[width=1\linewidth]{meshingTable.png}    
      }
      \caption{Meshroom Meshing Node}
      \label{tab:Meshing}
      \end{table}      
...
\begin{table}[H]
  \centering
  \makebox[\textwidth]
  {\includegraphics[width=1\linewidth]{mesh_filtering_table.png}    
  }
  \caption{Meshroom Mesh FilteringNode}
  \label{tab:MeshFiltering}
  \end{table}  
  ...
  %   \end{table}
    ...
    \begin{table}[H]
      \centering
      \makebox[\textwidth]
      {\includegraphics[width=1\linewidth]{texturing_table.png}    
      }
      \caption{Meshroom Texturing Node}
      \label{tab:Texturing}
      \end{table}    
...
The iteration process starts to adjust the target point cloud, and it will adjust the final scale. The results can be observed o
