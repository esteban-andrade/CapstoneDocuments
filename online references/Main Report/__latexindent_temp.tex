...
\subsubsection*{Lidar}
The Lidar used for the data acquisition process in an Intel RealSense L5
% The devices consist of a set of eight Tall Poles and four short Poles. 

% In the set of eight Tall poles, each pole will have three cameras attached to them. 
% The first camera will be located on top of the pole and it will directed and  oriented downwwards towards the person to have the adequeate overlap with the field of view. 
% The second camera is located on the middle region of the pole and it will be parallel oriented to the person in order to have the best field of view. 
% The third camera is located at the botton of the pole and it will be oriented upward towards the person in order to have best coverage based on the field of view. 
% The Tall poles will be placed and arranged in a circular manner in order to capture as much data as possible 

% \begin{wrapfigure}{r}{0.25\textwidth}
%   \begin{center}
%     \includegraphics[width=0.2\textwidth]{IMG_5895_cropped.jpg}
%   \end{center}
%   \caption{Tall Pole Cameras Location.}
%   \label{fig:poles_camera_tall}
% \end{wrapfigure}

% Figure \ref{fig:poles_camera_tall}, shows the location of the camaras and 
