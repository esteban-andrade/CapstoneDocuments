...
All the availible fields are illustrated on table \ref{tab:CameraInit}. Nevertheless in this project, the following fields were configured, whereas the remaining stayed as default.
...
\end{description}
All the other settings were configured as default.
...
All the other fields were configured as default. 
\begin{figure}[H]%this figure will be at the right
  \centering
...
All the remaining paramaters stayed as default.
\begin{figure}[H]%this figure will be at the right
  \centering
...
All the remaining parameters stayed as default.
\begin{figure}[H]%this figure will be at the right
  \centering
...
\end{description}
All the remaining settings are configured as default. 
...
The Meshing is the nineth step of the  
