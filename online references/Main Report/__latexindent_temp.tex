...
Once a connection is established, a trial run will be perform to ensure the cameras are working as intended.
...
The entire process takes approximately ten seconds. Once the data is captures, it can be used in the photogrammetry pipeline for reconstruction.
